                                            ...
                                            @foreach ($dataPanoramaConnect as $item) 
                                                <tr class="odd">
                                                    ...
                                                    <td style="">
                                                        ...
                                                        <form action="{{route('admin.adminWisataPanoramaConnectDestroy',$item->id)}}" method="POST">
...
<script>
    $(document).ready(function(){
        $('#createButton').click(function(){
            window.location.href = '{{route('admin.adminWisataPanoramaConnectCreate')}}';
        });
        ...
        $('#panoramaConnect').on('click','.edit', function () {            
            ...
            $.ajax({
                type : 'POST',
                url : '{{route('admin.adminWisataPanoramaConnectEdit')}}',
                cache: false,
                data : {
                    _token : "{{ csrf_token();  }}",
                    id:id
