                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-primary">
                            <h3 class="card-title">Daftar Data Wisata</h3>
                            <div class="card-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <button id="createButton" class="btn btn-success btn-sm">Tambah Data Wisata</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="example2_wrapper" class="table-responsive dataTables_wrapper dt-bootstrap5">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="tourist" class="table table-bordered table-hover dataTable dtr-inline"
                                            ...
                                            @foreach ($touristSpotData as $item) 
                                                <tr class="odd">
                                                    ...
                                                    <td style="">
                                                        ...
                                                        <form action="{{route('admin.adminWisataDestroy',$item->id)}}" method="POST">
                                                            <div class="btn-group btn-group-sm">
                                                                <a class="btn btn-warning edit" href="{{route('admin.adminWisataEdit' , $item->id )}}" 
                                                                    ><i class="fas fa-pen"></i>
                                                                    Edit</a>
                                                                <a href="{{route('admin.adminWisataShow', $item->id )}}" class="btn btn-info detail"><i class="fas fa-eye"></i>
                                                                    Detail</a>
                                                                @csrf
...
<script>
    $(document).ready(function(){
        $('#createButton').click(function(){
            window.location.href = '{{route('admin.adminWisataCreate')}}';
        });
        $('#tourist').on('click', '.delete-confirm', function (e) {
