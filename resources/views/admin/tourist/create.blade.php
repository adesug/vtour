            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form id="addWisata" action="{{route('admin.adminWisataStore')}}" method="POST" enctype="multipart/form-data">
                          @csrf
                          <div class="card-body">
                              <!-- Input lainnya -->
                              ...
                              {{-- <div class="form-group">
                                ...
                                <input type="file" name="foto_panorama" class="form-control mb-2">
                            </div>
                              <div class="form-group">
                                <label>Judul Panorama</label>
                                <input type="text" name="panorama_title" class="form-control mb-2">
                            </div> --}}
