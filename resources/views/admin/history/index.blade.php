                                            ...
                                            @foreach ($historyData as $item) 
                                                <tr class="odd">
                                                    ...
                                                    <td style="">
                                                        ...
                                                        <form action="{{route('admin.adminSejarahDestroy',$item->id)}}" method="POST">
                                                            <div class="btn-group btn-group-sm">
                                                                <a class="btn btn-warning edit" href="{{route('admin.adminSejarahEdit',$item->id)}}" 
                                                                    ><i class="fas fa-pen"></i>
                                                                    Edit</a>
                                                                <a href="{{route('admin.adminSejarahShow',$item->id)}}" class="btn btn-info detail"><i class="fas fa-eye"></i>
                                                                    Detail</a>
                                                                @csrf
...
<script>
    $(document).ready(function(){
        $('#createButton').click(function(){
            window.location.href = '{{route('admin.adminSejarahCreate')}}';
        });
