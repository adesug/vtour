                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                                    aria-label="Browser: activate to sort column ascending" style="">Nama Sejarah</th>
                                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
...
<script>
    $(document).ready(function(){
        $('#createButton').click(function(){
            window.location.href = '{{route('admin.adminSejarahPanoramaCreate')}}';
        });
        $('#panorama').on('click','.edit', function () {            
            var id = $(this).attr('id');
            $.ajax({
                type : 'POST',
                url : '{{route('admin.adminSejarahaPanoramaEdit')}}',
                cache: false,
                data : {
                    _token : "{{ csrf_token();  }}",
                    id:id
