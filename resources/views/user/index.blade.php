...
<head>
    ...
    <title>Tegal Virtual Tour</title>
...
<body>
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://res.cloudinary.com/dallljsye/image/upload/v1727843170/carousel2_sq8spb.jpg"
            ...
            <div class="carousel-item">
                <img src="https://res.cloudinary.com/dallljsye/image/upload/v1727843716/carousel5_msjjiq.jpg"
                    class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>First slide label</h5>
                    <p>Some representative placeholder content for the first slide.</p>
            ...
            <div class="carousel-item">
                <img src="https://res.cloudinary.com/dallljsye/image/upload/v1727843177/carousel3_dgpv1d.jpg"
                    class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>First slide label</h5>
                    <p>Some representative placeholder content for the first slide.</p>
    ...
    <div class="container mt-5">
        <h2 class="my-4 text-center">Gallery Wisata</h2> <!-- Title Added -->
        ...
        <h2 class="my-4 text-center">Gallery Kuliner</h2> <!-- Title Added -->
        <div class="row shadow-lg p-3 mb-5 bg-body-tertiary rounded">
